...
//MODIFIED by VC-fengwen 2007/08/13 <begin> :
//#define	MAX_SOURCES_FILE_UDP	50
#define	MAX_SOURCES_FILE_UDP	500
//MODIFIED by VC-fengwen 2007/08/13 <end> :
#define MAX_SOURCES_FILE_FROM_KAD	2000 //ADDED by VC-fengwen 2007/08/13 : 
...
#define	MAX_UP_CLIENTS_ALLOWED	256			// max. clients allowed regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too low, use DATARATE to adjust uploadspeed per client
#define	MIN_UP_CLIENTS_ALLOWED	6			// min. clients allowed to download regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too high
...
#define OP_TCPSECALLBACKREQ     0xF9	// <HASH 16>
#define OP_TCPSENATACK          0xFA    // <HASH 16><uint32><uint16>
#define OP_TCPSENATREQ          0xFB    // <HASH 16><uint32><uint16>


//Edit by jimmyc [2008-10-14]
//Stat Server OP Codes
#define OP_VC_STAT_HEADER	0xf2
#define OP_STAT_POST		0xf2
#define OP_STAT_FB			0xf2
#define OP_STAT_INSTALL		0x84
...
#define OP_UDPKEEPALIVE         0xF4    // (NULL)
#define OP_UDPREGISTER	        0xF5    // <HASH 16>
#define OP_UDPTOUDPSENATACK     0xF6    // <HASH 16><uint32><uint16>
#define OP_UDPTOUDPSENATREQ     0xF7    // <HASH 16><uint32><uint16>
#define OP_UDPSENATACK          0xFC    // <HASH 16><HASH 16>
#define OP_UDPSENATREQ          0xFD    // <HASH 16><HASH 16>
...
#define	 FT_URLSOURCE			 0x33	// <string>		//ADDED by fengwen on 2006/09/01 : Record url sources to local storage.
#define	 FT_ALREADFETCHURLSRC	 0x34	// <uint32>		//ADDED by fengwen on 2006/09/29 : 记录下，是否已经去服务器取过url源。
