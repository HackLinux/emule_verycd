...
void CSharedFilesWnd::OnBnClickedReloadsharedfiles()
{
	...
	Reload();
#ifdef _DEBUG
	//CPartFile * f=theApp.downloadqueue->GetFileByIndex(0);//  dl.sharedfiles->m_Files_map.GetStartPosition();
	//fg.SubmitED2KResource(_T("C:\\testhash\\testhash.rar"));
	//return;
	//uchar hash[] = {0x7E, 0xCD, 0x64, 0xF3, 0x27, 0x4E, 0x11, 0xCF,
	//	0x89, 0x7B, 0x8A, 0xB9, 0x07, 0x16, 0x7B, 0x12};
	//uchar hash[] ={0xA3, 0xDC, 0x5A, 0xA4, 0x1B, 0x78, 0x82, 0xC3, 0xE0, 0xF3, 0xD5, 0x39, 0xF5, 0x54, 0xD0, 0x0E
	//};
	//fg.RequestHttpUrl(hash);
#endif
}
